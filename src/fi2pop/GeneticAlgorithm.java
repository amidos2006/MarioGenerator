...
public class GeneticAlgorithm {
    ...
    public GeneticAlgorithm(SlicesLibrary lib, Random rnd, int populationSize, int chromosomeLength, int appendingSize, double crossover,
	...
	for(int i=0; i<this._population.length; i++) {
	    ...
	    this._population[i].randomInitialize();
	}
    }
